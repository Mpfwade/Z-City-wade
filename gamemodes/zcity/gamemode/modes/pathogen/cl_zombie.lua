...
net.Receive("zb_zombriefing", function()
	vgui.Create("ZB_ZomBriefing")
end)

net.Receive("zb_zomzombriefing", function()
	vgui.Create("ZB_ZomZomBriefing")
end)

net.Receive("zb_zomtraitorbriefing", function()
	vgui.Create("ZB_ZomTraitorBriefing")
end)

net.Receive("zb_commandertransmit", function()
	if IsValid(zb.DialogueWindow) then return end

	local dialogue = vgui.Create("ZB_zDialogue")
...
net.Receive("zb_contractortransmit", function()
	...
	local dialogue = vgui.Create("ZB_zDialogueTraitor")
	dialogue:SetTextAutoClose(net.ReadString())
end)
...
net.Receive("ZB_Pathogen_RoundEnd", function()
	...
	local panel = vgui.Create("ZB_PathogenEnd")
