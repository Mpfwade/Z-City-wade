...
local text = "There's an undead pathogen ravaging your current area. Your location is now under immediate quarantine until further notice, we'll try to figure out the means of your extraction in the meantime."

local COMMANDER = Material("hud/t_victories_counter-terrorist-eliminated", "smooth")
...
function PANEL:Paint(w, h)
	...
	draw.GlowingText("Patient #0", "ZB_PathowogenDialogueTitle", w * 0.31, 0 - ScreenScale(1), ColorAlpha(red, 255), ColorAlpha(red, 235), ColorAlpha(red, 10), TEXT_ALIGN_LEFT)
...
vgui.Register("ZB_DialogueZom", PANEL, "EditablePanel")