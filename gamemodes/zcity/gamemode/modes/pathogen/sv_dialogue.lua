MODE.FirstCasualtyCommander = {
	"I've just detected the first infection. The threat is real. Be cautious.",
	"One already down, don't let them make you the next one. Stay sharp.",
	"I lost tracking from one of you, most likely infected. Stay alert.",
	"One of you just got infected. You could be next, stay vigilant and don't let them get you."
}

MODE.HalfWayCommander = {
	"There's only half of you left now. Stay together.",
	"Half of you are either dead or infected now. May God help you all.",
	"The undead has already spread to half of you. Stay safe, and check your corners.",
...
MODE.HalfWayHeliCommander = {
	...
	"Half of you are either dead or infected now. The extraction helicopter is coming, hang in there!",
	"The undead has already spread to half of you. I got the extraction helicopter ready, just stay human a little longer!",
...
MODE.HalfWayExtractCommander = {
	...
	"Half of you are either dead or infected now. The extraction squad is coming, hang in there!",
	"The undead has already spread to half of you. I got the extraction squad on it's way, just stay human a little longer!",
...
MODE.FirstCasualtyContractor = {
	...
	"One dead survivor.",
	"Someone is dead now. Infected or shot, it doesn't matter. Continue."
}
