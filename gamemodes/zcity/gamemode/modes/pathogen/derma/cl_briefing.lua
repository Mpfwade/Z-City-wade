...
function PANEL:Init()
	...
	self.dialogue = self:Add("ZB_zDialogue")
	self.dialogue:SetPos(ScrW() / 2 - self.dialogue:GetWide() / 2, ScrH() / 2 - self.dialogue:GetTall() / 2)

	self.dialogue:SetText("There's an undead pathogen ravaging your current area. Your location is now under immediate quarantine until further notice, we'll try to figure out the means of your extraction in the meantime.", 2)
...
vgui.Register("ZB_ZomBriefing", PANEL, "EditablePanel")